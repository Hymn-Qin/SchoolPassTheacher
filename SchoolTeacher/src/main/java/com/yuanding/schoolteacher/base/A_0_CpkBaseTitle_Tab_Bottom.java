 ...
 */
package com.yuanding.schoolteacher.base;
...
import com.yuanding.schoolteacher.B_Side_Attence_Main_A3_Detail;
import com.yuanding.schoolteacher.B_Side_Notice_Main_Add_Contacts2;
import com.yuanding.schoolteacher.BackHandledFragment;
import com.yuanding.schoolteacher.BackHandledInterface;
import com.yuanding.schoolteacher.R;
import com.yuanding.schoolteacher.base.A_0_CpkBaseTitle_Middle.MyConnectionStatusListener;
import com.yuanding.schoolteacher.base.A_0_CpkBaseTitle_Tab.FinishReceiver;
import com.yuanding.schoolteacher.utils.AppStrStatic;
import com.yuanding.schoolteacher.utils.PubMehods;
import com.yuanding.schoolteacher.view.frament.TitleIndicatorBottom;;
...
public abstract class A_0_CpkBaseTitle_Tab_Bottom extends FragmentActivity implements
		View.OnClickListener,OnPageChangeListener ,BackHandledInterface {
	...
	public static final int BOTTOM_CANCEL = 5;
	public static final int BOTTOM_COMMIT = 6;
    public static final int ZUI_RIGHT_TEXT = 7;
    public static final int SHARE_Bottom = 8;

	private TextView titleText, titleTextCenter,tv_has_chooesed,tv_title;
	private LinearLayout mLinerBack, liner_titlebar_zui_right,
			liner_titlebar_pian_right,share_bottom;
	private Button btn_cancle,btn_sure,tv_title_tab_zuiyou_text;
	...
	// 选项卡控件
	protected TitleIndicatorBottom mIndicator;
	public static int isSpecial;//1,表示带有图片的选项卡
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv_title_tab_zuiyou_text = (Button)findViewById(R.id.tv_title_tab_bottom_zuiyou_text);
	...
	public void onClick(View v) {
		...
		case R.id.btn_cancle:
			handleTitleBarEvent(BOTTOM_CANCEL, v);
			break;
			
		case R.id.btn_sure:
			handleTitleBarEvent(BOTTOM_COMMIT, v);
			break;
        case R.id.tv_title_tab_bottom_zuiyou_text:
	...
	public void setBottomName(String resid) {
		tv_title.setVisibility(View.VISIBLE);
		tv_title.setText(resid);
	}
	public void setTitleBottom(String resid) {
		tv_has_chooesed.setVisibility(View.VISIBLE);
		tv_has_chooesed.setText(resid);
	}
	// 设置最右图片
	@SuppressLint("NewApi")
   ...
   public void setZuiYouText(String resid){
	...
	public TitleIndicatorBottom getIndicator() {
		return mIndicator;
	}
	//将带有图片的选项卡布局右侧的图片返回出去
	public TextView getTvSum(){
		return mIndicator.tvSum;
	}
	...
	public final void initViews() {
		...
		mIndicator = (TitleIndicatorBottom) findViewById(R.id.pagerindicator);
	...
	public void onPageSelected(int position) {
		...
		A_0_App.add_position=position;
		Intent intent1 = new Intent("acctence_add");
		intent1.putExtra("all", "change");
		if (!isFinishing()) {
	...
	protected int getMainViewResId() {
		return R.layout.titled_fragment_tab_activity_bottom;
	}
            ...
            switch (connectionStatus) {
                ...
                case KICKED_OFFLINE_BY_OTHER_CLIENT:// 用户账户在其他设备登录，本机会被踢掉线
                    ...
                    class LooperThread extends Thread {
                        public void run() {
                            Looper.prepare();
                            A_0_App.getInstance().showExitDialog(A_0_CpkBaseTitle_Tab_Bottom.this, AppStrStatic.kicked_offline());
                            Looper.loop();
                        }
                    }
