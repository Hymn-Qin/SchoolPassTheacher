 ...
 * @Description: 通用标题栏：包含标题、搜素、地图按钮、返回按钮    title为下拉效果
 * @author Jiaohaili 
 *
 */
public abstract class A_0_CpkBaseTitle_Middle extends FragmentActivity implements View.OnClickListener{
	...
	private LinearLayout mLinerBack,mLinerSelect,liner_titlebar_zui_right,liner_titlebar_pian_right;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.titlebar_base_middle);
		
        titleText = (TextView) findViewById(R.id.tv_titlebar_title_middle);
        tv_zuiyou_text = (Button)findViewById(R.id.tv_title_zuiyou_text_middle);
        mLinerBack = (LinearLayout) findViewById(R.id.liner_titlebar_back_middle);
        mLinerSelect = (LinearLayout) findViewById(R.id.liner_title_middle);
        liner_titlebar_zui_right = (LinearLayout) findViewById(R.id.liner_titlebar_zui_right_middle);
        liner_titlebar_pian_right = (LinearLayout) findViewById(R.id.liner_titlebar_pian_right_middle);
        
        iv_pian_right = (ImageView) findViewById(R.id.iv_pian_right_middle);
        iv_zui_right = (ImageView) findViewById(R.id.iv_zui_right_middle);
        
        mLinerBack.setOnClickListener(this);
        mLinerSelect.setOnClickListener(this);
	...
	public void onClick(View v) {
		...
		switch (v.getId()) {
		case R.id.liner_titlebar_back_middle:
			handleTitleBarEvent(BACK_BUTTON,v);
			break;
	    
	     case R.id.liner_title_middle:
            handleTitleBarEvent(MIDDLE_CLICK,v);
            break;  
	            
		case R.id.liner_titlebar_zui_right_middle:
			handleTitleBarEvent(ZUI_RIGHT_BUTTON,v);
			break;
			
		case R.id.liner_titlebar_pian_right_middle:
			handleTitleBarEvent(PIAN_RIGHT_BUTTON,v);
			break;
			
		case R.id.tv_title_zuiyou_text_middle:
	...
	{
		LinearLayout lin=(LinearLayout)findViewById(R.id.base_content_base_middle);
	...
	* @param @param bShow 
	...
	protected void showTitleBt(int btTag,boolean bShow)
	{
        ...
        }else if (btTag == MIDDLE_CLICK) {
            if(bShow)
            {
                mLinerSelect.setVisibility(View.VISIBLE);
            }else{
                mLinerSelect.setVisibility(View.GONE);
            }
            ...
            switch (connectionStatus) {
                ...
                case KICKED_OFFLINE_BY_OTHER_CLIENT:// 用户账户在其他设备登录，本机会被踢掉线
                    ...
                    class LooperThread extends Thread {
                        public void run() {
                            Looper.prepare();
                            A_0_App.getInstance().showExitDialog(A_0_CpkBaseTitle_Middle.this, AppStrStatic.kicked_offline());
                            Looper.loop();
                        }
                    }
