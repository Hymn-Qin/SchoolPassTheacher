...
import com.yuanding.schoolteacher.utils.ImageGridAdapter;
import com.yuanding.schoolteacher.utils.ImageGridAdapter.TextCallback;
import com.yuanding.schoolteacher.utils.ImageItem;
...
public class B_Side_Found_Add_ImageGridActivity extends A_0_CpkBaseTitle_Navi {
	...
	Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
			case 0:
				PubMehods.showToastStr(B_Side_Found_Add_ImageGridActivity.this, "最多选择"+A_0_App.Notice_more+"张图片");
				break;
...
//			}
		...
		case ZUI_RIGHT_TEXT:
			...
			for (int i = 0; i < list.size(); i++) {
				if (Bimp.drr.size() <A_0_App.Notice_more) {
