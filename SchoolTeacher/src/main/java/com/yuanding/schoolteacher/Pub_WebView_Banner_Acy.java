...
public class Pub_WebView_Banner_Acy extends A_0_CpkBaseTitle_Navi {
    ...
    private String tag_show_refresh_btn,tag_show_forward_btn = "";//1：显示刷新、转发按钮。2：不显示
...
//        A_0_App.getInstance().WB_BangDou_Tag = 1;
        ...
        startActivity(new Intent(Pub_WebView_Banner_Acy.this, A_3_0_Login_Acy_Teacher.class));
    ...
    protected void handleTitleBarEvent(int resId, View v) {
        switch (resId) {
            ...
            case PIAN_RIGHT_BUTTON:
                isInstallWeiXin = ShareUtil.isInstallTargetMedia(Pub_WebView_Banner_Acy.this, SHARE_MEDIA.WEIXIN);
