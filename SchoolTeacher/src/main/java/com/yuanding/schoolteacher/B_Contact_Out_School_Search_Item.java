...
import com.yuanding.schoolteacher.service.Api.InterSchoolOutAll;
...
import com.yuanding.schoolteacher.view.contact.CustomEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
                ...
                .setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
                    ...
                    public void onPullUpToRefresh(
                        ...
                        if (repfresh == 0) {
                            ...
                            getMoreData(CustomEditText_out_school_dd.getText()
                                    .toString(), have_read_page);
                        }
                    }
                });
        ...
        mPullDownView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int posi,
                ...
                namePhone = sortDataList.get(posi - 1).getInfo_name();
                telephone = sortDataList.get(posi - 1).getPhone();
...
//	);
    ...
    public void requestCallPhoneSuccess() {
        PubMehods.callPhone(B_Contact_Out_School_Search_Item.this, telephone);
    }
    ...
    public DisplayImageOptions getOption(int cate_id) {
        if (cate_id == 1) {
            //bitmapUtils=A_0_App.getBitmapUtils(this,R.drawable.school_list_express_center,R.drawable.school_list_express_center);
            ...
            options = A_0_App.getInstance().getOptions(
                    ...
                    R.drawable.school_list_takeout_center,
                    R.drawable.school_list_takeout_center);
            //bitmapUtils=A_0_App.getBitmapUtils(this,R.drawable.school_list_takeout_center,R.drawable.school_list_takeout_center);
        } else if (cate_id == 3) {
            options = A_0_App.getInstance().getOptions(
                    R.drawable.school_list_bank_center,
                    R.drawable.school_list_bank_center,
                    R.drawable.school_list_bank_center);
            //bitmapUtils=A_0_App.getBitmapUtils(this,R.drawable.school_list_bank_center,R.drawable.school_list_bank_center);
        } else if (cate_id == 4) {
            options = A_0_App.getInstance().getOptions(
                    R.drawable.school_list_trip__center,
                    R.drawable.school_list_trip__center,
                    R.drawable.school_list_trip__center);
            //bitmapUtils=A_0_App.getBitmapUtils(this,R.drawable.school_list_trip__center,R.drawable.school_list_trip__center);
        } else if (cate_id == 5) {
            options = A_0_App.getInstance().getOptions(
                    R.drawable.school_list_entertainment_center,
                    R.drawable.school_list_entertainment_center,
                    R.drawable.school_list_entertainment_center);
            //bitmapUtils=A_0_App.getBitmapUtils(this,R.drawable.school_list_entertainment_center,R.drawable.school_list_entertainment_center);
        }
        return options;
    }
...
//									totleSize + 1);
    ...
    public class Mydapter extends BaseAdapter {
        ...
        public View getView(int posi, View converView, ViewGroup arg2) {
            ...
            //bitmapUtils=getOption(Integer.parseInt(sortDataList.get(posi).getCate_id()));
            ...
            //bitmapUtils.display(por, sortDataList.get(posi).getInfo_icon());
            rel.setTag(posi);
            rel.setOnClickListener(new OnClickListener() {
                @Override
                public void onClick(View v) {
                    namePhone = sortDataList.get((Integer) v.getTag()).getInfo_name();
                    telephone = sortDataList.get((Integer) v.getTag()).getPhone();
                    A_0_App.getInstance().callSb(B_Contact_Out_School_Search_Item.this, namePhone, telephone, new A_0_App.PhoneCallBack() {
                                @Override
                                public void sPermission() {
                                    MPermissions.requestPermissions(B_Contact_Out_School_Search_Item.this, REQUECT_CODE_CALLPHONE, Manifest.permission.CALL_PHONE);
