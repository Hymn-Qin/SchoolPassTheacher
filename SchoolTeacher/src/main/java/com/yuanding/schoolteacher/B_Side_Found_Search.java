...
import com.yuanding.schoolteacher.service.Api.InterLostSearchList;
...
public class B_Side_Found_Search extends A_0_CpkBaseTitle_Navi{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		utilsXiao=A_0_App.getBitmapUtils(B_Side_Found_Search.this, R.drawable.ic_default_empty_bg, R.drawable.ic_default_empty_bg,false);
		mPullDownView
				.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
					...
					public void onPullDownToRefresh(
						...
						String label = DateUtils.formatDateTime(
								B_Side_Found_Search.this,System.currentTimeMillis(),
	...
	private void getLectureList(int page_no,String keyword,final boolean pullRefresh) {
		A_0_App.getApi().getLostSearchList(B_Side_Found_Search.this,A_0_App.USER_TOKEN, String.valueOf(page_no),keyword,
		...
		public View getView(final int posi, View converView, ViewGroup arg2) {
			...
			if (mLecturesList.get(posi).getPhoto_url().length()>0&&mLecturesList.get(posi).getPhoto_url()!="") {
				...
				if (photo_urls.length==1) {
		            ...
		            LinearLayout horizonLayout = new LinearLayout(B_Side_Found_Search.this);
...
//							startActivity(intent);
		            ...
		            for (int i = 0; i < photo_urls.length; i++) {
		                params = new RelativeLayout.LayoutParams(
		                        (int) (imageLayWidth / 3), (int) (imageLayWidth / 3));
		                ImageView image2 = new ImageView(B_Side_Found_Search.this);
		                final int a = i;
		                ...
		                String uri2 = photo_urls[i];
						if(image2.getTag() == null){
							PubMehods.loadServicePic(imageLoader,uri2,image2, options);
						    image2.setTag(uri2);
						}else{
						    if(!image2.getTag().equals(uri2)){
						    	PubMehods.loadServicePic(imageLoader,uri2,image2, options);
						        image2.setTag(uri2);
						    }
						}
