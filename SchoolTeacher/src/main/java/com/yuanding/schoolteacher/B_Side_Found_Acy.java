...
public class B_Side_Found_Acy extends Fragment {
	...
	private void readCache() {
		...
		jsonObject = maACache
				.getAsJSONObject(AppStrStatic.cache_key_side_found_acy+A_0_App.USER_UNIQID);
	...
	private void getLectureList(int page_no, final boolean pullRefresh) {
		A_0_App.getApi().getLostList(getActivity(),"1",A_0_App.USER_TOKEN, String.valueOf(page_no),
				new InterLostList() {
					@Override
	...
	private void getMoreLecture(int page_no) {
		if (A_0_App.USER_TOKEN == null || A_0_App.USER_TOKEN.equals(""))
			return;
		A_0_App.getApi().getLostList(getActivity(),"1",
