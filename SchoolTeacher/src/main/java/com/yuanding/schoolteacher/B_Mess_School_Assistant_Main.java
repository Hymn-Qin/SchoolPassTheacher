...
import com.yuanding.schoolteacher.service.Api.InterSchoolAssistantMainList;
...
public class B_Mess_School_Assistant_Main extends A_0_CpkBaseTitle_Navi{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        options = A_0_App.getInstance().getOptions(R.drawable.icon_side_nothing, R.drawable.icon_side_nothing,
                R.drawable.icon_side_nothing);
