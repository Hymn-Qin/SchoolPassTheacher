 ...
 * 学生的列表通讯录
 */
public class B_Contact_Main_Student_List extends A_0_CpkBaseTitle_Navi implements SideBar.OnTouchingLetterChangedListener, TextWatcher {
...
//		mListView.setMode(Mode.BOTH);
		...
		mListView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
					...
					public void onPullDownToRefresh(PullToRefreshBase<ListView> refreshView) {
						String label = DateUtils.formatDateTime(B_Contact_Main_Student_List.this,
		...
		sortDataList.clear();
		mAdapter = new SchoolFriendMemberListAdapter(B_Contact_Main_Student_List.this, sortDataList);
	...
	private void initData() {
		...
		A_0_App.getApi().getStuContactList(B_Contact_Main_Student_List.this,"1",contact_stu_id,A_0_App.USER_TOKEN, new InterStuContactList() {
					@Override
                    ...
                    public void onFailure(String msg) {
                        if (sortDataList == null)
                            return;
                        PubMehods.showToastStr(B_Contact_Main_Student_List.this,msg);
				...
				holder.tvContent.setOnClickListener(new OnClickListener() {
					...
					public void onClick(View v) {
						Cpk_Persion_Contact dd = (Cpk_Persion_Contact) v
								.getTag();
						Intent intent = new Intent(B_Contact_Main_Student_List.this,
				...
				if(dto.getIs_invite()==1){					
					...
					holder.btn_invative.setOnClickListener(new OnClickListener() {							
						...
						public void onClick(final View arg0) {							
							...
							final GeneralDialog upDateDialog = new GeneralDialog(B_Contact_Main_Student_List.this, R.style.Theme_GeneralDialog);
							upDateDialog.setTitle(R.string.pub_title);
							upDateDialog.setContent("您正在邀请 "+dto.getName()+" 使用"+A_0_App.APP_NAME);
							...
							upDateDialog.showRightButton(R.string.pub_sure, new OnClickListener() {
								...
								public void onClick(View v) {
									 ...
									 * 调接口发送短信
									 */
									if(NetUtils.isConnected(B_Contact_Main_Student_List.this)){
										...
										upDateDialog.cancel();
										PubMehods.showToastStr(B_Contact_Main_Student_List.this, "请检查您的网络设置");
									}
        ...
        public void onChanged(ConnectionStatus connectionStatus) {
            ...
            switch (connectionStatus) {
                ...
                case DISCONNECTED:// 断开连接。
                    ...
                    //A_0_App.getInstance().showExitDialog(B_Contact_Main_Student_List.this,getResources().getString(R.string.token_timeout));
                    break;
                case CONNECTING:// 连接中。
                ...
                case KICKED_OFFLINE_BY_OTHER_CLIENT:// 用户账户在其他设备登录，本机会被踢掉线
                    ...
                    class LooperThread extends Thread {
                        public void run() {
                            Looper.prepare();
                            A_0_App.getInstance().showExitDialog(B_Contact_Main_Student_List.this, AppStrStatic.kicked_offline());
                            Looper.loop();
                        }
                    }
