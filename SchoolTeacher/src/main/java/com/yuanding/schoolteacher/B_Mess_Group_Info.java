...
public class B_Mess_Group_Info  extends Activity {
	...
	private TextView tv_group_info_banji,tv_group_info_count,tv_clear_message;
	...
	private Cpk_Group_Info getInfo(JSONObject jsonObject) {
		// TODO Auto-generated method stub
			...
			if (state == 1) {
				...
				info.setClassname(jsonObject.optString("organ_name"));
   ...
   private void showSuccessInfo(Cpk_Group_Info info) {
        ...
        String str_title = "部门信息(" + info.getMlist().size() + "人)";
