 ...
 * 转发选择 我的同事无限极机构
 */
public class B_Mess_Forward_Select_Colleague_Cla  extends A_0_CpkBaseTitle_Navi {
        ...
        mPullDownView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int position,long arg3) {
                ...
                if (Integer.parseInt(mClasslist.get(posi).getChild_total_num()) > 0) {
                    ...
                    Intent intent = new Intent(B_Mess_Forward_Select_Colleague_Cla.this,B_Mess_Forward_Select_Colleague_List.class);
          ...
          mPullDownView.setOnRefreshListener(new PullToRefreshBase.OnRefreshListener2<ListView>() {
              ...
              public void onPullDownToRefresh(
                  ...
                  String label = DateUtils.formatDateTime(B_Mess_Forward_Select_Colleague_Cla.this,
        ...
        public View getView(int posi, View converView, ViewGroup arg2) {
            if (converView == null) {
                converView = LayoutInflater.from(
                        B_Mess_Forward_Select_Colleague_Cla.this).inflate(R.layout.item_contace_student_class, null);
            }
