...
import com.yuanding.schoolteacher.service.Api.InterAttdenceList;
...
import com.yuanding.schoolteacher.view.SolveClashListView;
 ...
 * 课堂考勤主界面
 */
public class B_Side_Attence_Main_A0 extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		viewone = inflater.inflate(R.layout.activity_side_attendence_main, container,
				false);
	    firstLoad_Tag = true;
        ...
        iv_blank_title.setText("没有课堂考勤记录~");
...
//            showLoadResult(false, false, false, true);
    ...
    /**
   	...
   	void report_Dialog() {
   		...
   		dialog.setContentView(R.layout.activity_side_select_attence);
   		dialog.show();
   		Button btn_attence_reply=(Button) dialog.findViewById(R.id.btn_attence_reply);
   		Button btn_attence_report=(Button) dialog.findViewById(R.id.btn_attence_report);
   		LinearLayout liner_info_dailog=(LinearLayout) dialog.findViewById(R.id.liner_info_dailog);
   		btn_attence_reply.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View v) {
				 Intent intent=new Intent();
		            intent.setClass(getActivity(),B_Side_Attence_Main_A1_New_Attence.class);
   		...
   		btn_attence_report.setOnClickListener(new OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent();
				intent.setClass(getActivity(),B_Side_Attence_Main_A1_New_Attence.class);
   		...
   		liner_info_dailog.setOnTouchListener(new OnTouchListener() {
	...
	private void goDtail(List<Cpk_Side_Attence> list,int posi,boolean earlyAttence) {
        ...
        if(attence_atd_id == null || attence_atd_id.equals(""))
            return;
        Intent intent=new Intent(getActivity(), B_Side_Attence_Main_A3_Detail.class);
    ...
    private void addHeadView(PullToRefreshListView mListview) {
        ...
        View view = getActivity().getLayoutInflater().inflate(R.layout.item_index_side_accence, mListview, false);
	...
	private void getAttdenceList(final int page_no) {
	    A_0_App.getApi().getAttdenceList(getActivity(), A_0_App.USER_TOKEN, String.valueOf(page_no), new InterAttdenceList() {
            @Override
            public void onSuccess(List<Cpk_Side_Attence> mToadayList, List<Cpk_Side_Attence> mEarlyList) {
                if(getActivity()==null||getActivity().isFinishing())
                    return;
            	havaSuccessLoadData = 2;  
        ...
        A_0_App.getApi().getAttdenceList(getActivity(), A_0_App.USER_TOKEN, String.valueOf(page_no), new InterAttdenceList() {
            ...
            public void onSuccess(List<Cpk_Side_Attence> mToadayList, List<Cpk_Side_Attence> mEarlyList) {
                ...
                if (mEarlyList!= null && mEarlyList.size() > 0) {
                    ...
                    PubMehods.showToastStr(getActivity(),R.string.pub_is_lastest);
                }
                if(null!=mPullDownView){
                    mPullDownView.onRefreshComplete();
                }
    ...
    public class MyIndexAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertview, ViewGroup arg2) {
            ...
            if (convertview == null) {
                ...
                convertview = View.inflate(getActivity(),R.layout.item_side_attence_main, null);
...
//            startActivity(new Intent(getActivity(), B_Side_Attence_Main_A1_New_Attence.class));
//            break;
//		case PIAN_RIGHT_BUTTON:
//		    Intent intent=new Intent();
//            intent.setClass(getActivity(),Pub_WebView_Load_Other_Acy.class);
...
//	
	...
	public void onResume() {
        if (!firstLoad_Tag&&A_0_App.SIDE_ATTENCE==0) {
            have_read_page = 1;
            getAttdenceList(have_read_page);
        } else {
            logD(" 第一次进入页面不刷新");
    ...
    public static void logD(String msg) {
        com.yuanding.schoolteacher.utils.LogUtils.logD("B_Side_Attence_Main_A0", "B_Side_Attence_Main_A0==>" + msg);
    }

    public static void logE(String msg) {
        com.yuanding.schoolteacher.utils.LogUtils.logE("B_Side_Attence_Main_A0", "B_Side_Attence_Main_A0==>" + msg);
    }
