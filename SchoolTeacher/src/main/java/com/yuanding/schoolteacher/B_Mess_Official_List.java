...
import com.yuanding.schoolteacher.service.Api.InterNoticeOfficialList;
import com.yuanding.schoolteacher.service.Api.InterUpdateOfficialList;
...
public class B_Mess_Official_List extends A_0_CpkBaseTitle_Navi {
	...
	private CharSequence getTextAndImage(String title){
		ImageSpan is = new ImageSpan(B_Mess_Official_List.this,R.drawable.file_zhizhen);
		String space = "   ";
		title = title + space;
		...
		public View getView(final int posi, View converView, ViewGroup arg2) {
			...
			if (converView == null) {
				converView = LayoutInflater.from(B_Mess_Official_List.this)
						.inflate(R.layout.item_notificity_list, arg2, false);
				...
				if (mCourseList.get(posi).getType().equals("4")) {
					...
					switch (mCourseList.get(posi).getIs_appendix()){
						...
						case 1:
							...
							Drawable drawable = ContextCompat.getDrawable(B_Mess_Official_List.this, R.drawable.file_zhizhen);
...
//			}
			...
			holder.liner_checkbox.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					System.out.println(">>>>>>>>>>"+mCourseList.get(posi).isSelected());
					if (mCourseList.get(posi).isSelected() == false) {
