...
public class A_Main_My_Contact_Acy extends A_0_CpkBaseTitle_Tab {
    ...
    protected int supplyTabs(List<TabInfo> tabs) {
        ...
        tabs.add(new TabInfo(FRAGMENT_ONE, "同事", B_Contact_Main_Colleague_Class.class));
        tabs.add(new TabInfo(FRAGMENT_TWO, "学生", B_Contact_Main_Student_Class.class));
   ...
   public static void logD(String msg) {
        com.yuanding.schoolteacher.utils.LogUtils.logD("A_Main_My_Contact_Acy", "A_Main_My_Contact_Acy=teacher=>" + msg);
    }

    public static void logE(String msg) {
        com.yuanding.schoolteacher.utils.LogUtils.logE("A_Main_My_Contact_Acy", "A_Main_My_Contact_Acy=teacher=>" + msg);
    }
}
