 ...
 * 我的同事无极限机构
 */
public class B_Contact_Main_Colleague_Class extends BackHandledFragment {
	...
	public FinishFirstReceiver finishReceiver;
	/**
	 * 0,正，1，返回
	 */
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		finishReceiver = new FinishFirstReceiver();
		...
		mPullDownView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int position,long arg3) {
                ...
                if (Integer.parseInt(mClasslist.get(posi).getChild_total_num()) > 0) {
                    ...
                    Intent intent = new Intent(getActivity(),B_Contact_Main_Colleague_List.class);
	...
	private void getData(String organ_id) {
		A_0_App.getApi().getStuClassList("0",organ_id, A_0_App.USER_TOKEN,is_back,new InterStuClassList() {
					@Override
    ...
    public class FinishFirstReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context arg0, Intent arg1) {
            ...
            if (arg1.getStringExtra("name").equals("colleagure")) {
			...
			} else if(arg1.getStringExtra("name").equals("0")){
				if (!str_result_level.equals("0")) {
                    A_0_App.hadIntercept = false;
                } else {
                    A_0_App.hadIntercept = true;
