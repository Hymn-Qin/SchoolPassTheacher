...
public class B_Account_MySet_About_Acy extends A_0_CpkBaseTitle_Navi{
	...
	private TextView tv_about_app_version,tv_temp_str_name,tv_temp_bottom;
	...
	private TextView tv_about_app_arguement;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv_temp_str_name=(TextView) findViewById(R.id.tv_temp_str_name);
		tv_temp_bottom=(TextView) findViewById(R.id.tv_temp_bottom);
		...
		tv_temp_str_name.setText(AppStrStatic.app_str_name());
		tv_temp_bottom.setText(AppStrStatic.str_about_copyright_bottom());
		...
		LinearLayout.LayoutParams layoutParams = new LinearLayout.LayoutParams(
					...
					ViewGroup.LayoutParams.WRAP_CONTENT);
        int top=DensityUtils.dip2px(this, 53);
