package com.yuanding.schoolteacher.utils.download;
...
import com.yuanding.schoolteacher.B_Account_My_Set_Acy;
import com.yuanding.schoolteacher.R;
import com.yuanding.schoolteacher.bean.Cpk_Version;
import com.yuanding.schoolteacher.service.Api.InterCheckVersion;
	        ...
	        upDateDialog.showRightButton(R.string.pub_update, new OnClickListener() {
	            ...
	            public void onClick(View v) {
	                if (A_0_App.getInstance().getVersion() != null&& A_0_App.getInstance().getVersion().getDownloadUrl().length() > 0)
	                    ...
	                    }else if(A_3_0_Login_Acy_Teacher.getInstance() != null){
                            A_3_0_Login_Acy_Teacher.getInstance().startDownloadApp(A_0_App.getInstance().getVersion().getDownloadUrl());
	                    }
	                else
