...
import com.yuanding.schoolteacher.service.Api.InterCall_Back;
import com.yuanding.schoolteacher.service.Api.Inter_Call_Back;
import com.yuanding.schoolteacher.service.Api.Inter_Change_Mobile;
import com.yuanding.schoolteacher.utils.AppStrStatic;
import com.yuanding.schoolteacher.utils.PubMehods;
import com.yuanding.schoolteacher.utils.ReadSmsContent;
...
public class A_3_5_Change_No_Acy  extends A_0_CpkBaseTitle_Navi{
	...
	private LinearLayout ll_login_pwd,ll_new_phone,ll_get_yanzheng_code;
	@Override
	protected void onCreate(Bundle savedInstanceState) {
		...
		ll_get_yanzheng_code=(LinearLayout) findViewById(R.id.ll_get_yanzheng_code);
		...
		tv_yanzheng_text_code.setOnFocusChangeListener(new OnFocusChangeListener() {
			...
			public void onFocusChange(View arg0, boolean arg1) {
				...
				if(arg1)
				{
					ll_get_yanzheng_code.setBackgroundResource(R.drawable.login_input_hover_bg);
				}else
				{
					ll_get_yanzheng_code.setBackgroundResource(R.drawable.login_input_normal_bg);
				}
			}
		});
	...
	private void changge_moblile(String mobile,String code,String passwd){
	    A_0_App.getInstance().showProgreDialog(A_3_5_Change_No_Acy.this, "处理中，请稍候",true);
...
//					 tv_yanzheng_text_code.setText(code); 展示返回的验证码
//				 }else{
