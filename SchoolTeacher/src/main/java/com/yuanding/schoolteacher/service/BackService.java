...
public class BackService extends Service {
	...
	public static final String MESSAGE_ACTION="com.yuanding.schoolteacher.message_ACTION";
	public static final String HEART_BEAT_ACTION="com.yuanding.schoolteacher.heart_beat_ACTION";
    ...
    public static void logD(String msg) {
        LogUtils.logD("BackService","BackService==>" + msg);
    }

    public static void logE(String msg) {
        LogUtils.logE("BackService","BackService==>" + msg);
    }
}
