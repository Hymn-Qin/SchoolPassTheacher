...
import com.yuanding.schoolteacher.service.Api.InterSideRepairSent;
import com.yuanding.schoolteacher.service.Api.InterSideRepairTypeList;
...
public class B_Side_Repair_Add extends A_0_CpkBaseTitle_Navi {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setView(R.layout.activity_side_add_repair);
		setTitleText("新增报修");
...
//			}
//		});
		tv_type.setInputType(InputType.TYPE_NULL);
...
//				PubMehods.showToastStr(B_Side_Repair_Add.this, "请勿重复操作！");
    ...
    public void sent(){
        ...
        A_0_App.getInstance().showProgreDialog(
                B_Side_Repair_Add.this, "发送中，请稍候",true);
        ...
        public void onChanged(ConnectionStatus connectionStatus) {
            ...
            switch (connectionStatus) {
                ...
                case DISCONNECTED:// 断开连接。
                    ...
                    //A_0_App.getInstance().showExitDialog(B_Side_Add_Repair.this,getResources().getString(R.string.token_timeout));
                    break;
                case CONNECTING:// 连接中。
