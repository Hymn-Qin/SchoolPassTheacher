...
import com.yuanding.schoolteacher.service.Api.InterLostList;
import com.yuanding.schoolteacher.service.Api.InterSideFoundDelete;
...
public class B_Side_Found_My extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		utilsXiao=A_0_App.getBitmapUtils(getActivity(), R.drawable.ic_default_empty_bg, R.drawable.ic_default_empty_bg,false);
	...
	private void getLectureList(int page_no, final boolean pullRefresh) {
		A_0_App.getApi().getLostList(getActivity(), "0", A_0_App.USER_TOKEN,
	...
	public class Mydapter extends BaseAdapter {
		...
		public View getView(final int posi, View converView, ViewGroup arg2) {
			...
			if (lmap.get(posi) == null) {
				...
				holder.tv_lost_phone=(TextView) converView.findViewById(R.id.tv_lost_phone);
            ...
            if(mLecturesList.get(posi).getType().equals("1"))
            {
            	...
            	holder.temp002.setText("拾获地点：");
            	holder.temp004.setText("拾获时间：");
            }else{
            	holder.temp001.setText("丢失物品：");
            	holder.temp002.setText("丢失地点：");
            	holder.temp004.setText("丢失时间：");
            }
				...
				if (photo_urls.length == 1) {
					...
					image1.setOnLongClickListener(new OnLongClickListener() {
						...
						public boolean onLongClick(View arg0) {
							if (mLecturesList.get(posi).getIs_self()
									.equals("1")) {
								callSb(mLecturesList.get(posi).getLost_id(),
										posi);
							}
							return false;
						}
...
//						imageLoader
//								.displayImage(photo_urls[i], image2, options);
