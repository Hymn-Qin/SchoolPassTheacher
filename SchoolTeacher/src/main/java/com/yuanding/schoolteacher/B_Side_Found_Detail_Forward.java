...
public class B_Side_Found_Detail_Forward extends A_0_CpkBaseTitle_Navi {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        utilsXiao = A_0_App.getBitmapUtils(B_Side_Found_Detail_Forward.this, R.drawable.ic_default_empty_bg,
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.btn_persion_info_tel:
                    ...
                    A_0_App.getInstance().callSb(B_Side_Found_Detail_Forward.this, namePhone, telephone, new A_0_App.PhoneCallBack() {
                                @Override
                                public void sPermission() {
                                    MPermissions.requestPermissions(B_Side_Found_Detail_Forward.this, REQUECT_CODE_CALLPHONE, Manifest.permission.CALL_PHONE);
                                }
                            }
                    );
                    break;
...
//	);
    ...
    private void showWindow(View parent) {
        ...
        int x = DensityUtils.dip2px(B_Side_Found_Detail_Forward.this, 165);
