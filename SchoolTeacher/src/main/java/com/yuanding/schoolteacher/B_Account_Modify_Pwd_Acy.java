...
import com.yuanding.schoolteacher.service.Api.Inter_Change_Pwd;
...
public class B_Account_Modify_Pwd_Acy extends A_0_CpkBaseTitle_Navi{
	...
	private LinearLayout ll_old_pwd,ll_new_pwd,ll_sure_new_pwd;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		ll_sure_new_pwd=(LinearLayout) findViewById(R.id.ll_sure_new_pwd);
       ...
       user_sure_new_pwd.setOnFocusChangeListener(new OnFocusChangeListener() {
		...
		if(arg1)
		{
			ll_sure_new_pwd.setBackgroundResource(R.drawable.login_input_hover_bg);
		}else
		{
			ll_sure_new_pwd.setBackgroundResource(R.drawable.login_input_normal_bg);
		}
	    }
     });
