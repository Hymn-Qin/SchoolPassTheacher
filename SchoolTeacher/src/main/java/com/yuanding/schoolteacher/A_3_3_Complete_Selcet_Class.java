...
import com.yuanding.schoolteacher.service.Api.InterTeachOrganList;
...
public class A_3_3_Complete_Selcet_Class extends A_0_CpkBaseTitle_Navi {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mPullDownView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int posi,long arg3) {
				String targetId = mClassList.get(posi).getOrgan_name();
				...
				if (Integer.parseInt(mClassList.get(posi).getChild_total_num()) == 0) {
					...
					intent.putExtra("organ_name",targetIdLength.substring(0, targetIdLength.lastIndexOf("-")));
					setResult(3, intent);
					finish();
				}
			}
	...
	public class MyClassAdapter extends BaseAdapter {
		...
		public View getView(int posi, View converView, ViewGroup arg2) {
			if (converView == null) {
				converView = LayoutInflater.from(A_3_3_Complete_Selcet_Class.this).inflate(R.layout.item_select_school_text, null);
			}
