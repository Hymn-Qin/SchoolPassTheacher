	...
	public class Mydapter extends BaseAdapter {
		...
		public View getView(final int posi, View converView, ViewGroup arg2) {
			...
			if (mLecturesList.get(posi).getStatus().equals("0")) {
				...
				holder.tv_lost_type.setTextColor(getResources().getColor(color.repair_blue));
			} else{
				holder.tv_lost_type.setText("物归原主");
				holder.tv_lost_type.setTextColor(getResources().getColor(color.GREENlIGHT));
			}
...
//		                        (int) (4 * density), (int) (4 * density));
		              ...
		              //  imageLoader.displayImage(photo_urls[i], image2,options);
	...
	class ViewHolder {
		...
		TextView temp001,temp004,temp002;
