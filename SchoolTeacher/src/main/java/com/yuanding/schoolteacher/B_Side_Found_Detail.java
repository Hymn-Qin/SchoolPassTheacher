...
import com.yuanding.schoolteacher.service.Api.InteFoundDetail;
import com.yuanding.schoolteacher.service.Api.InterSideFoundStatus;
...
public class B_Side_Found_Detail extends A_0_CpkBaseTitle_Navi {
    ...
    private TextView tv_detail_name, tv_detail_create_time, tv_detail_school,
            ...
            tv_detail_phone, tv_detail_lost_desc, tv_detail_goods;
    ...
    private LinearLayout ll_lost_person;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        utilsXiao = A_0_App.getBitmapUtils(B_Side_Found_Detail.this, R.drawable.ic_default_empty_bg, R.drawable.ic_default_empty_bg, false);
        ...
        ll_lost_person = (LinearLayout) findViewById(R.id.ll_lost_person);
        tv_detail_goods = (TextView) findViewById(R.id.tv_detail_goods);
        ...
        tv_detail_goods.setText(cpk_Side_Lost_List.getName());
...
//								R.drawable.navigationbar_text_button_normal));
            ...
            ll_lost_person.setVisibility(View.GONE);
            ...
            ll_lost_person.setVisibility(View.VISIBLE);
        ...
        if (cpk_Side_Lost_List.getPhoto_url().length() > 0 && cpk_Side_Lost_List.getPhoto_url() != "") {
            ...
            if (photo_urls.length == 1) {
                ...
                if (photo_urls[0] != null) {
                    PubMehods.loadBitmapUtilsPic(utilsXiao, image1, photo_urls[0]);
                }
                ...
                for (int i = 0; i < photo_urls.length; i++) {
                    ...
                    if (photo_urls[i] != null) {
                        PubMehods.loadBitmapUtilsPic(utilsXiao, image2, photo_urls[i]);
                    }

                    //imageLoader.displayImage(photo_urls[i], image2, options_photo);
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.btn_persion_info_tel:
                    namePhone = cpk_Side_Lost_List.getTrue_name();
                    telephone = cpk_Side_Lost_List.getPhone();
                    A_0_App.getInstance().callSb(B_Side_Found_Detail.this, namePhone, telephone, new A_0_App.PhoneCallBack() {
                                @Override
                                public void sPermission() {
                                    MPermissions.requestPermissions(B_Side_Found_Detail.this, REQUECT_CODE_CALLPHONE, Manifest.permission.CALL_PHONE);
                                }
                            }
                    );
                    break;
...
//	);
    ...
    void changeStatus() {
        A_0_App.getInstance().showProgreDialog(B_Side_Found_Detail.this, "提交中，请稍候", true);
    ...
    private void showWindow(View parent) {
        if (statusPopup == null) {
            ...
            if (cpk_Side_Lost_List.getIs_self().equals("1")) {
                mLinerCollct.setVisibility(View.VISIBLE);
            } else {
                mLinerCollct.setVisibility(View.GONE);
            }
        ...
        mLinerForward.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(B_Side_Found_Detail.this, B_Mess_Forward_Select.class);
                ...
                if (cpk_Side_Lost_List.getPhoto_url().length() > 0 && cpk_Side_Lost_List.getPhoto_url() != "") {
                    ...
                    if (photo_urls.length == 1) {
                        ...
                        for (int i = 0; i < photo_urls.length; i++) {
                            ...
                            //imageLoader.displayImage(photo_urls[i], image2, options_photo);
                            image2.setScaleType(ScaleType.CENTER);
                            image2.setOnClickListener(new OnClickListener() {
