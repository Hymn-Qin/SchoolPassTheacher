 ...
 *
 */
public class B_Side_Notice_Receipt_UnRece extends Fragment{
   ...
   // protected BitmapUtils bitmapUtils;
    ...
    private String type = "0";   // 0 未回执  1 已回执
	...
	private List<Cpk_NoticeReceIpt> getList(JSONObject jsonObject) {
		// TODO Auto-generated method stub
			...
			if (state == 1) {
				...
				B_Side_Notice_Receipt_Main.getmInstace().updateChildTitle(0, "未回执（"+countNum+"）");
			}
			return mlistContact;
	}
