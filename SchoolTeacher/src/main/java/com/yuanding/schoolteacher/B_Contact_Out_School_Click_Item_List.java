...
import com.yuanding.schoolteacher.service.Api.InterSchoolOutList;
...
//	        bitmapUtils=A_0_App.getBitmapUtils(B_Contact_Out_School_Click_Item_List.this, R.drawable.school_list_pub_img, R.drawable.school_list_pub_img);
        ...
        mPullDownView.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int posi, long arg3) {
                ...
                namePhone = list.get(posi - 1).getInfo_name();
                telephone = list.get(posi - 1).getPhone();
                A_0_App.getInstance().callSb(B_Contact_Out_School_Click_Item_List.this, namePhone, telephone, new A_0_App.PhoneCallBack() {
                            @Override
                            public void sPermission() {
                                MPermissions.requestPermissions(B_Contact_Out_School_Click_Item_List.this, REQUECT_CODE_CALLPHONE, Manifest.permission.CALL_PHONE);
                            }
                        }
                );
...
//	);
    ...
    public void requestCallPhoneSuccess() {
        PubMehods.callPhone(B_Contact_Out_School_Click_Item_List.this, telephone);
    }
    ...
    private void readCache(int cate_id) {
        ...
        jsonObject = maACache.getAsJSONObject(AppStrStatic.cache_key_school_out_click + A_0_App.USER_UNIQID + cate_id);
