...
public class Cpk_SysNotice_ItemUserDetail {
	...
	long comment_create_time;
	
	String to_comment_content;
	String title;
	long to_comment_create_time;
	...
	public long getTo_comment_create_time() {
		return to_comment_create_time;
	}
	public void setTo_comment_create_time(long to_comment_create_time) {
