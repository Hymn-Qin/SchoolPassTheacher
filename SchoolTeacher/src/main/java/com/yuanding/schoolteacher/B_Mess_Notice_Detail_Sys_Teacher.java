...
import static com.yuanding.schoolteacher.R.id.tv_acy_detail_title;
 ...
 * 通知详情
 */
public class B_Mess_Notice_Detail_Sys_Teacher extends A_0_CpkBaseTitle_Navi {
...
//    webSettings.setDefaultFontSize(16);
    ...
    private void readData(String message_id) {
        A_0_App.getApi().getNoticeDetail(B_Mess_Notice_Detail_Sys_Teacher.this,school_notice, A_0_App.USER_TOKEN, 
                message_id,AppStrStatic.cache_key_mess_detail_sys+A_0_App.USER_UNIQID,"0", new InterNoticeDetail() {
            @Override
            public void onSuccess(Cpk_Notice_Detail notice) {
                ...
                if(notice.getBg_img() != null && notice.getBg_img().length()>0 && !notice.getBg_img().equals("")){
                    ...
                    if(iv_notice_detail_banner.getTag() == null){
                    	PubMehods.loadServicePic(imageLoaderBanner,uri,iv_notice_detail_banner, optionsBanner);
                ...
                //tv_message_detail_notice_time.setText(notice.getNoticeFrom);
            ...
            public void onFailure(String msg) {
                if(isFinishing())
                  return;
                PubMehods.showToastStr(B_Mess_Notice_Detail_Sys_Teacher.this, msg);
    ...
    private void goAcy() {
        if (acy_type != 2) {// 推送
            if (A_Main_Acy.getInstance() != null) {
                ...
                startAcy(B_Mess_Notice_Detail_Sys_Teacher.this, A_Main_Acy.class);
            }
        } else {// 正常进入
            goData();
            finish();
...
//                    A_0_App.getInstance().showExitDialog(B_Mess_Notice_Detail_Sys.this,getResources().getString(R.string.token_timeout));
                ...
                case KICKED_OFFLINE_BY_OTHER_CLIENT:// 用户账户在其他设备登录，本机会被踢掉线
                    ...
                    class LooperThread extends Thread {
                        public void run() {
                            Looper.prepare();
                            A_0_App.getInstance().showExitDialog(B_Mess_Notice_Detail_Sys_Teacher.this, AppStrStatic.kicked_offline());
                            Looper.loop();
                        }
                    }
