...
import com.yuanding.schoolteacher.database.DBManager;
import com.yuanding.schoolteacher.database.UserInfos;
import com.yuanding.schoolteacher.database.UserInfosDao;
...
public class RongActivity extends FragmentActivity implements Handler.Callback {
    ...
    private D_UpLoad_LoadingDialog mDialog;
    ...
    */}
    ...
    private void reconnect(String token) {
        ...
        mDialog = new D_UpLoad_LoadingDialog(this);
