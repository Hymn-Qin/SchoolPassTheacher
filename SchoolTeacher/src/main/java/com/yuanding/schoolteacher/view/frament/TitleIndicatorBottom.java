 ...
 */
package com.yuanding.schoolteacher.view.frament;
...
import com.yuanding.schoolteacher.base.A_0_CpkBaseTitle_Tab_Bottom.TabInfo;

/**
 *这是个选项卡式的控件，会随着viewpager的滑动而滑动
 */
@SuppressWarnings("static-access")
public class TitleIndicatorBottom extends LinearLayout implements View.OnClickListener,
        OnFocusChangeListener {
    @SuppressWarnings("unused")
    private boolean DEBUG = false;

    @SuppressWarnings("unused")
    private static final String TAG = "TitleIndicatorBottom";
     ...
     * Default constructor
     */
    public TitleIndicatorBottom(Context context) {
        super(context);
     ...
     * @param attrs
     */
    public TitleIndicatorBottom(Context context, AttributeSet attrs) {
        super(context, attrs);
        setFocusable(true);
    ...
    private void add2(int index, String label, int icon, boolean hasTips) {
		// TODO Auto-generated method stub
    	 View tabIndicator;
         tabIndicator = mInflater.inflate(R.layout.title_flow_indicator_v4, this, false);
...
//        }
    ...
    //添加带有图片的选项卡布局
    protected void add(int icon){
    	View tabIndicator = mInflater.inflate(R.layout.title_flow_indicator_v3, this, false);
    	tips = (ImageView) tabIndicator.findViewById(R.id.tab_title_tips);
    	tvSum = (TextView) tabIndicator.findViewById(R.id.tab_title_sum);
    ...
    public synchronized void setCurrentTab(int index) {
        ...
        setIndicator(getChildAt(3));
        /*********************************************************/
//      (ImageView)newTab.findViewById(R.id.tab_title_tips).setVisibility(View.GONE);
//      ImageView imagview=((ImageView)getChildAt(3).findViewById(R.id.tab_title_tips));
//        if(index==3&&getIcon(index)>0){
//         imagview.setVisibility(View.VISIBLE);
//         imagview.setBackgroundResource(R.drawable.side_share_downing_selected);
//        }else
//        {
//          imagview.setBackgroundResource(R.drawable.side_share_downing);
//        }
        /*********************************************************/
