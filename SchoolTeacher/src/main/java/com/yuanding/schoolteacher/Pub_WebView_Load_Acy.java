...
import com.yuanding.schoolteacher.view.ProgressWebView;

/**
 * @author Jiaohaili 
 * @version 创建时间：2015年11月11日 上午9:13:39 
 * 加载webview url  不启用缓存模式
 * 我的邦豆、短信账户、用户协议、我的邀请说明
 */
...
public class Pub_WebView_Load_Acy extends A_0_CpkBaseTitle_Navi {
    ...
    private String tag_show_refresh_btn,tag_show_help_btn = "";//1：显示刷新按钮。2：不显示
    private String tag_skip = "";//1：不再过滤，支持跳转  2：页面主动过滤掉超链接点击不再跳转。
    private int acy_type;//1表示邦豆进入  2表示短信账户
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent() != null){
            ...
            tag_show_help_btn=getIntent().getExtras().getString("tag_show_help_btn");
            ...
            if(tag_show_help_btn != null && tag_show_help_btn.equals("1")){
...
//          	 isFailed=true;
    ...
    private void exit_login() {
        ...
        startActivity(new Intent(Pub_WebView_Load_Acy.this, A_3_0_Login_Acy_Teacher.class));
    ...
    protected void handleTitleBarEvent(int resId, View v) {
        switch (resId) {
            ...
            case PIAN_RIGHT_BUTTON:
                if (acy_type == 2) {
                    Intent intent = new Intent(Pub_WebView_Load_Acy.this, Pub_WebView_Banner_Acy.class);
                    intent.putExtra("title_text", getResources().getString(R.string.str_my_sms_help));
                    intent.putExtra("url_text", AppStrStatic.LINK_USER_SMS_HELP);
                    intent.putExtra("tag_show_refresh_btn", "0");
    ...
    public static void logE(String msg) {
        LogUtils.logE("Pub_WebView_Load_Acy", "Pub_WebView_Load_Acy==>" + msg);
    }
    @Override
