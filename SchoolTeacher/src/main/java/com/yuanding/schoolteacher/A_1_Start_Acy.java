...
import com.yuanding.schoolteacher.service.Api.Inter_GetStartupPic;
            ...
            if (!MPermissions.shouldShowRequestPermissionRationale(A_1_Start_Acy.this, Manifest.permission.RECORD_AUDIO, REQUECT_CODE_RECORD_AUDIO)) {
                ...
                if (!MPermissions.shouldShowRequestPermissionRationale(A_1_Start_Acy.this, Manifest.permission.CAMERA, REQUECT_CODE_CAMERA)) {
                    ...
                    if (!MPermissions.shouldShowRequestPermissionRationale(A_1_Start_Acy.this, Manifest.permission.READ_PHONE_STATE, REQUECT_READ_PHONESTATE)) {
                        ...
                        if (!MPermissions.shouldShowRequestPermissionRationale(A_1_Start_Acy.this, Manifest.permission.CALL_PHONE, REQUECT_CODE_CALL)){
...
//        });
    ...
    private void showIntroduction() {
        ...
        if (null != A_0_App.USER_TOKEN && !"".equals(A_0_App.USER_TOKEN)) {
             ...
             */
            startAcy(A_1_Start_Acy.this, A_3_0_Login_Acy_Teacher.class);
        }
...
//		overridePendingTransition(R.anim.animal_slide_in_bottom_normal, R.anim.animal_push_left_out_normal);
    ...
    public static void pushOperating(Context context, Class<?> cls) {
        ...
        if (!"".equals(reqpagetype) && !reqpagetype.isEmpty()) {
            ...
            if (reqpagetype.equals("m1")) {
                intent.setClass(context, B_Mess_Notice_Detail_Teacher.class);
                intent.putExtra("acy_type", 3);
            } else if (reqpagetype.equals("m2")) {
                intent.setClass(context, B_Mess_Notice_Detail_MessText_Teacher.class);
                intent.putExtra("acy_type", 3);
            } else if (reqpagetype.equals("m3")) {
                intent.setClass(context, B_Mess_Notice_Detail_Sys_Teacher.class);
                intent.putExtra("acy_type", 3);
                ...
                intent.setClass(context, B_Side_Acy_list_Detail_Acy_Teacher.class);
                intent.putExtra("acy_type", 3);
            } else if (reqpagetype.equals("l1")) {
                intent.setClass(context, B_Side_Lectures_Detail_Acy_Teacher.class);
                intent.putExtra("acy_type", 3);
                ...
                intent.putExtra("acy_type", 1);//推送进入
            } else if (reqpagetype.equals("au1")) {
                intent.setClass(context, B_Mess_School_Assistant_3_Detai_Examine_Acy.class);
                intent.putExtra("acy_type", 1);//推送进入
            } else if (reqpagetype.equals("sc1")) {
                intent.setClass(context, B_Side_Course_Acy.class);
                intent.putExtra("acy_type", 1);//推送进入
            } else if (reqpagetype.equals("tm1")) {
                intent.setClass(context, B_Mess_School_Assistant_0_List_Acy.class);
                intent.putExtra("acy_type", 1);//推送进入
    ...
    private static final int REQUECT_CODE_CALL= 10;//内存卡
    ...
    {
        MPermissions.requestPermissions(A_1_Start_Acy.this, REQUECT_CODE_CALL, Manifest.permission.CALL_PHONE);
    }
    ...
    @PermissionDenied(REQUECT_CODE_CALL)
    public void requestCallFailed() {
        showTitleDialog("拍照");
    }

    @PermissionGrant(REQUECT_CODE_CALL)
