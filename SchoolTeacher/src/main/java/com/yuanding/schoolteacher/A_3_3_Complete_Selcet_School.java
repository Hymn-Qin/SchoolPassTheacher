...
import com.yuanding.schoolteacher.service.Api.InterSchoolList;
...
public class A_3_3_Complete_Selcet_School extends A_0_CpkBaseTitle_Navi {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		liner_whole_view_school = findViewById(R.id.liner_select_school_whole_view);
	...
	public class MyAdapter extends BaseAdapter {
		...
		public View getView(int posi, View converView, ViewGroup arg2) {
			if (converView == null) {
				converView = LayoutInflater.from(A_3_3_Complete_Selcet_School.this).inflate(R.layout.item_select_school_text, null);
			}
