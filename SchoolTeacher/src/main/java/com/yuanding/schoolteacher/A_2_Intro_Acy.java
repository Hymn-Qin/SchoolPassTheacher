...
//					mIvEnterHome.setVisibility(View.GONE);
   ...
   private class MyPagerAdapter extends PagerAdapter {
	...
	private void goMainAcy() {
		...
		startActivity(new Intent(A_2_Intro_Acy.this, A_3_0_Login_Acy_Teacher.class));
		overridePendingTransition(R.anim.animal_slide_in_bottom, R.anim.animal_push_left_out_normal);
		finish();
