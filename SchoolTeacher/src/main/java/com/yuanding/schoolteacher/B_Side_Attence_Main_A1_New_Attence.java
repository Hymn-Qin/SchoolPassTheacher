...
import com.yuanding.schoolteacher.service.Api.InterSideAddAttence;
...
public class B_Side_Attence_Main_A1_New_Attence extends A_0_CpkBaseTitle_Navi {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (type.equals("0")) {
            et_attence_participantor.setHint("添加需要考勤的班级");
        } else {
            et_attence_participantor.setHint("添加需要考勤的分组");
        }
        // 添加考勤人
        btn_add_participantor.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (type.equals("0")) {
                    ...
                    intent.setClass(B_Side_Attence_Main_A1_New_Attence.this,
                            B_Side_Attence_Main_Add_Contacts.class);// B_Side_Attence_Main_Add_Contacts
                } else {
                    ...
                    intent.setClass(B_Side_Attence_Main_A1_New_Attence.this,
                            B_Side_Attence_Main_Class_Defined.class);// B_Side_Attence_Main_Add_Contacts
    ...
    private void AddAttence(String token, String title, String place, String organ_ids) {
        ...
        A_0_App.getApi().sideAddAttence(token, type, title, place, organ_ids,
                new InterSideAddAttence() {
                    ...
                    public void onSuccess(String message, String atd_id) {
                        ...
                        A_0_App.getInstance().CancelProgreDialog(
                                B_Side_Attence_Main_A1_New_Attence.this);
            ...
            if (!"".equals(organ_id)) {
                if (requestCode == IMAGE_REQUEST_CODE) {
                    if (organ_name.length() > 1 && organ_id.length() > 1) {
                        et_attence_participantor.setText(organ_name.substring(0,
                                organ_name.length() - 1));
    ...
    protected void handleTitleBarEvent(int resId, View v) {
        switch (resId) {
            ...
            case ZUI_RIGHT_BUTTON:
                ...
                if (participantor == null || participantor.length() <= 0
                        || participantor.equals("")) {
                    PubMehods.showToastStr(this, "请添加需要考勤的班级");
                    return;
                }
