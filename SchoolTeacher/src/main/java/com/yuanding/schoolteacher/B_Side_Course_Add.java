...
import com.yuanding.schoolteacher.bean.Cpk_Side_Course_Add;
import com.yuanding.schoolteacher.bean.Cpk_Side_Course_CourseDetail;
import com.yuanding.schoolteacher.bean.Cpk_Side_Course_Week_Select;
import com.yuanding.schoolteacher.service.Api.Inter_Call_Back;
import com.yuanding.schoolteacher.service.Api.Inter_Side_Course_Add;
import com.yuanding.schoolteacher.service.Api.Inter_Side_Course_Add_Sure;
...
import com.yuanding.schoolteacher.view.WheelView;
...
public class B_Side_Course_Add  extends A_0_CpkBaseTitle_Navi {
    ...
    private LinearLayout iv_courses_add; 
    private EditText et_course_name;
    private TextView tv_course_people_name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_course_people_name = (TextView)findViewById(R.id.tv_course_people_name);
        mylistview_course = (MyListView)findViewById(R.id.mylistview_course);
        
        tv_course_people_name.setText(A_0_App.USER_NAME);
...
//                    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (data != null && data.getExtras() != null
            ...
            String temp_cm_id = data.getExtras().getString("modify_id");
            if (requestCode == 2) {
    ...
    private void to_Add_Course_Action(final String semester_id,final String jsonWeeks,final String course_name,
            final String cm_id,final String token,String is_sure,final String is_edit,final String weekday_id) {
        A_0_App.getInstance().showProgreDialog(B_Side_Course_Add.this, "", true);
        A_0_App.getApi().add_Course_Action(semester_id, jsonWeeks, course_name, cm_id, token,is_sure,is_edit, weekday_id,new Inter_Side_Course_Add() {
            @Override
            public void onSuccess(int state,String message) {
                ...
                if(state ==2){
                    showUserConfirmDialog(message,semester_id, jsonWeeks, course_name, cm_id, token, is_edit,weekday_id);
                }else{
    ...
    private void to_Add_Course_Action_Sure(final String semester_id,final String jsonWeeks,final String course_name,final String cm_id,
            final String token,String is_sure,final String is_edit,String weekday_id) {
        A_0_App.getInstance().showProgreDialog(B_Side_Course_Add.this, "", true);
        A_0_App.getApi().add_Course_Action_Sure(semester_id, jsonWeeks, course_name, cm_id, token,is_sure,is_edit,weekday_id, new Inter_Side_Course_Add_Sure() {
            @Override
    ...
    public void showUserConfirmDialog(String titie,final String semester_id,String jsonWeeks,final String course_name,
            final String cm_id,String token,final String is_edit,final String weekday_id) {
        ...
        upDateDialog.showRightButton(R.string.pub_sure, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                to_Add_Course_Action_Sure(semester_id, JSONArray.toJSON(mCourseList).toString(),course_name, 
                        cm_id, A_0_App.USER_TOKEN, "1", is_edit,weekday_id);
            }
        });
        upDateDialog.show();
    }
