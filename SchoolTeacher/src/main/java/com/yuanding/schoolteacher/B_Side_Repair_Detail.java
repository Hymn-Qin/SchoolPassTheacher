...
import com.yuanding.schoolteacher.service.Api.InteRepairDetail;
import com.yuanding.schoolteacher.service.Api.InterSideRepairStatus;
...
public class B_Side_Repair_Detail extends A_0_CpkBaseTitle_Navi {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        jsonObject = maACache
                .getAsJSONObject(AppStrStatic.cache_key_repair_detail + A_0_App.USER_UNIQID
                        + repair_id);
                ...
                A_0_App.USER_TOKEN, repair_id, new InteRepairDetail() {
                    ...
                    public void onFailure(String msg) {
                        ...
                        if (!havaSuccessLoadData) {
                            PubMehods.showToastStr(B_Side_Repair_Detail.this,
                                    msg);
    ...
    public void Success(Cpk_Side_Repair_Detail detail) {
        ...
        if (cpk_Side_Repair_Detail.getStatus() != null) {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.btn_persion_info_tel:
                    namePhone = cpk_Side_Repair_Detail.getClass_name();
                    telephone = cpk_Side_Repair_Detail.getPhone();
                    A_0_App.getInstance().callSb(B_Side_Repair_Detail.this, namePhone, telephone, new A_0_App.PhoneCallBack() {
                                @Override
                                public void sPermission() {
                                    MPermissions.requestPermissions(B_Side_Repair_Detail.this, REQUECT_CODE_CALLPHONE, Manifest.permission.CALL_PHONE);
                                }
                            }
                    );
                    break;
...
//	);
    ...
    void changeStatus() {
        A_0_App.getInstance().showProgreDialog(
                B_Side_Repair_Detail.this, "发送中，请稍候", true);
        A_0_App.getApi().SideRepairStatus(A_0_App.USER_TOKEN, repair_id, new InterSideRepairStatus() {
